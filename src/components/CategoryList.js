...
import DeleteSweepIcon from '@mui/icons-material/DeleteSweep';  // import the 'e-junk' icon
...
const CategoryList = () => {
  const categories = [
    ...
    { name: 'Other', icon: <DeleteSweepIcon fontSize="large" /> }, // added 'Other' category with 'e-junk' icon
  ];
